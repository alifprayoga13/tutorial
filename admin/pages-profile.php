        ...
        <div class="wrapper">
            ...
            <div class="leftside-menu">
                ...
                <a href="Admin.html" class="logo text-center logo-light">
                    <span class="logo-lg">
                        <img src="assets/images/users/Logo.png" alt="" height="40">
                    </span>
                    <span class="logo-sm">
                        <img src="assets/images/users/logo_sm.png" alt="" height="40">
                    </span>
                </a>
                ...
                <a href="Admin.html" class="logo text-center logo-dark">
                    <span class="logo-lg">
                        <img src="assets/images/users/Logo_dark.png" alt="" height="40">
                    </span>
                    <span class="logo-sm">
                        <img src="assets/images/users/logo_sm_dark.png" alt="" height="40">
                    </span>
                </a>
                                ...
                                <div class="page-title-box">
                                    <div class="page-title-right">
                                        <ol class="breadcrumb m-0">
                                            ...
                                            <li class="breadcrumb-item"><a href="About.html">About As</a></li>
                                        </ol>
                                    </div>
                                        ...
                                        <div class="row">
                                            <div class="col-sm-8">
                                                <div class="row align-items-center">
                                                    <div class="col-auto">
                                                        <div class="avatar-lg">
                                                            <img src="assets/images/users/avatar-9.jpg" alt="" class="rounded-circle img-thumbnail">
                                                        </div>
                                                    </div>
                                                    <div class="col">
                                                        <div>
                                                            <h4 class="mt-1 mb-1 text-white">Adelia Zhafirah</h4>
                                                            <p class="font-13 text-white-50">Seller Brand</p>
    
                                                            <ul class="mb-0 list-inline text-light">
                                                                <li class="list-inline-item me-3">
                                                                    <h5 class="mb-1">$ 25,25</h5>
                                                                    <p class="mb-0 font-13 text-white-50">Total Pendapatan</p>
                                                                </li>
                                                                <li class="list-inline-item">
                                                                    <h5 class="mb-1">-</h5>
                                                                    <p class="mb-0 font-13 text-white-50">Limits</p>
                                                                </li>
                                                            </ul>
                                                        </div>
                                                    </div>

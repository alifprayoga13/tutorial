 ...
 if (mysqli_num_rows($query) > 0) {
    $row = mysqli_fetch_assoc($query);
            ...
            if(isset($_POST["submit"]) && isset($_FILES['my_image'])){
             ...
             $sql = "INSERT INTO `undangan`.`undangan` (`id_undangan`, `Judul`, `id_user`, `id_kategori`, `umur`, `nomor_panitia`, `tgl_acara`, `lokasi_acara`, `foto`, `nama_org_ultah`, `nomor_pemilik` ) VALUES (NULL, '".$judul."', '".$row["id_user"]."', '3', '".$umur."', '".$nomor_panitia."','".$tanggal."','".$lokasi_acara."','".$foto_mempelai."','".$nama."','".$nomor_pemilik."');";
...
<head>
    ...
    <div class="container">
    <h1 class="text-center">Lanjutkan</h1>
                        ...
                        <div class="row">
                            <div class="form-group form-float col-sm">
                                ...
                                <label class="form-label">Nama</label>
                                    <input type="text" name="nama_org_ultah" class="form-control email" >                               
                                </div>
                            </div>
                            <div class="form-group form-float col-sm">
                                <div class="form-line">
                                    <label class="form-label">umur</label>
                                    <input type="text" name="umur" class="form-control password"  >                                
                                </div>
                            </div>
                        </div>
                        <div class="row">
                            <div class="form-group form-float col-sm">
                                <div class="form-line">
                                    <label class="form-label">Nomor Panitia</label>
                                    <input type="text" name="nomor_panitia" class="form-control" >                                
                                </div>
                            </div>
                            <div class="form-group form-float">
                            <div class="form-line">
                                <label class="form-label">Nomor Pemilik</label>
                        ...
                        <div class="row">
                            <div class="form-group form-float col-sm">
                                ...
                                <label class="form-label">Tanggal Acara</label>
                                    <input type="date" name="tgl_acara" class="form-control email" >                               
                                </div>
                            </div>
                            <div class="form-group form-float col-sm">
                                <div class="form-line">
                                    <label class="form-label">Lokasi</label>
                                    <input type="text" name="lokasi_acara" class="form-control password"  >                                
                                </div>
                            </div>
                        </div>    
                        </div>             

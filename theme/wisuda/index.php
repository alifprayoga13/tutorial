...
$sql = "SELECT * FROM `undangan` WHERE `id_undangan` = ".$get_id." and id_kategori= 2";
...
<html lang="en">
  ...
  <body>
    ...
    <div class="header-wrapper" id="home">
      <!-- Begin Hero -->
      <section class="hero is-large" style="background-image: url('../../upload/wisudah/<?php echo $row["foto"]?>'); background: linear-gradient(rgba(153, 110, 109, 0.65), rgba(153, 110, 109, 0.65)), rgba(0, 0, 0, 0.55) url('../../upload/wisudah/<?php echo $row["foto"]?>') center no-repeat ; background-size: cover; ")>
        <!-- Begin Mobile Nav -->
        ...
        <div class="hero-body">
          <div class="container has-text-centered">
            <h2 class="title">Happy Graduation</h2>
    ...
    <!-- Begin regular-section-->
     <section class="section-light no-padding-top regular-section has-text-centered has-vertically-aligned-content" id="regular-section">
        ...
        <p class="bodytext" data-aos="fade-up" data-aos-easing="linear">
          ...
          <br>
          Acara Wisuda <?php echo $row["nama_kampus"]?>
        </p>
          ...
          <div class="columns is-multiline">          
            ...
            <div class="column is-12 prolog has-text-centered" data-aos="fade-up" data-aos-easing="linear">
              <p class="h2 subtitle">
                ...
                Menghadiri acara Wisuda Saya Di <?php echo $row["nama_kampus"]?>
                <br>
                <br>
                Jika bisa hadir silakan menuju wakil untuk scan QR Code 
                <br>
                Informasi: Dimohon untuk tertib, karena akan ada mahasiswa 
                <br>
                dan para walinya sendiri-sendiri
                yang nantinya juga datang diacara terimakasih.
                <br>
                <br>
                Jika tidak memungkinkan untuk hadir di acara Wisuda kami,tidak mengapa,
                <br> 
